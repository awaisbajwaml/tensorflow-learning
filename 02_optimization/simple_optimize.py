...
# x placeholder for out input data
x = tf.placeholder(tf.float64)

# a is the variable storing our values to optimize. It is initialised with starting "guess"
...
# the loss defines how wrong our model is, if the loss is 0 - there is no loss and the optimum is reached
...
# x is the training data, a is the variable value(initialized with a starting guessing value) which will be optimized
